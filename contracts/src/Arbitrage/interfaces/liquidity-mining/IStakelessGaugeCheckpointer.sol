...
interface IStakelessGaugeCheckpointer {
     ...
     */
    event GaugeAdded(
        IStakelessGauge indexed gauge,
        string indexed indexedGaugeType,
        string gaugeType
    );
     ...
     */
    function addGaugesWithVerifiedType(
    ...
    function getGaugeAtIndex(
        string memory gaugeType,
        uint256 index
    ) external view returns (IStakelessGauge);
     ...
     */
    function checkpointAllGaugesAboveRelativeWeight(
     ...
     * @param minRelativeWeight Threshold to filter out gauges below it.
     */
    function checkpointGaugesOfTypesAboveRelativeWeight(
     ...
     */
    function checkpointMultipleGaugesOfMatchingType(
        string memory gaugeType,
        IStakelessGauge[] memory gauges
    ) external payable;
     ...
     * @param minRelativeWeight Minimum relative weight filter: gauges below this value do not add to the bridge cost.
     */
    function getGaugeTypesBridgeCost(
        string[] memory gaugeTypes,
        uint256 minRelativeWeight
